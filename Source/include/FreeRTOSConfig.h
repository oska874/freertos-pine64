...
#define configASSERT( x ) if( ( x ) == 0 ) //{ vMainAssertCalled( __FILE__, __LINE__ ); }//M9C
...
Zynq MPU. */
#define configINTERRUPT_CONTROLLER_BASE_ADDRESS        0//M9C 
#define configINTERRUPT_CONTROLLER_CPU_INTERFACE_OFFSET 0//M9C
